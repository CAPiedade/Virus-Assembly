...
L = itertools.product(Matrizes,repeat=5)
for i in L:
    Matrizes.append(i[0])
    print len(Matrizes)
...
Mfinais=[]
for i in Matrizes:
    Mfinais.append(tuple(i.reshape(3600).tolist()))


print len(list(set(Mfinais)))



for c in itertools.combinations(Matrizes,2):
...
S =PermutationGroup([Permutation( 0, 1, 2, 3, 4) ( 9, 21, 40, 48, 32) ( 22, 41, 49, 33, 5) ( 8, 20, 44, 47, 31) ( 23, 42, 45, 34, 6) ( 24, 43, 46, 30, 7) ( 53, 29, 12, 35, 56) ( 52, 28, 11, 39, 55) ( 25, 13, 36, 57, 54) ( 51, 27, 10, 38, 59) ( 26, 14, 37, 58, 50) ( 16, 15, 19, 18, 17),
Permutation( 22, 23, 24, 20, 21) ( 0, 8, 52, 29, 41) ( 1, 9, 53, 25, 42) ( 5, 54, 26, 43, 2) ( 6, 50, 27, 44, 3) ( 7, 51, 28, 40, 4) ( 32, 55, 16, 13, 49) ( 33, 56, 17, 14, 45) ( 48, 31, 59, 15, 12) ( 46, 34, 57, 18, 10) ( 47, 30, 58, 19, 11) ( 35, 39, 38, 37, 36),
Permutation( 41, 42, 43, 44, 40) ( 1, 20, 28, 12, 49) ( 2, 21, 29, 13, 45) ( 0, 24, 27, 11, 48) ( 4, 23, 26, 10, 47) ( 3, 22, 25, 14, 46) ( 9, 52, 15, 36, 33) ( 32, 8, 51, 19, 35) ( 5, 53, 16, 37, 34) ( 6, 54, 17, 38, 30) ( 31, 7, 50, 18, 39) ( 57, 56, 55, 59, 58),
Permutation( 49, 45, 46, 47, 48) ( 2, 44, 11, 35, 33) ( 3, 40, 12, 36, 34) ( 1, 43, 10, 39, 32) ( 0, 42, 14, 38, 31) ( 4, 41, 13, 37, 30) ( 9, 20, 27, 18, 56) ( 22, 29, 15, 58, 6) ( 21, 28, 19, 57, 5) ( 8, 24, 26, 17, 55) ( 23, 25, 16, 59, 7) ( 53, 52, 51, 50, 54),
Permutation( 33, 34, 30, 31, 32) ( 3, 47, 39, 56, 5) ( 4, 48, 35, 57, 6) ( 0, 49, 36, 58, 7) ( 1, 45, 37, 59, 8) ( 2, 46, 38, 55, 9) ( 22, 40, 11, 18, 54) ( 21, 44, 10, 17, 53) ( 41, 12, 19, 50, 23) ( 24, 42, 13, 15, 51) ( 20, 43, 14, 16, 52) ( 25, 29, 28, 27, 26),
Permutation( 9, 5, 6, 7, 8) ( 0, 32, 56, 54, 23) ( 4, 31, 55, 53, 22) ( 1, 33, 57, 50, 24) ( 2, 34, 58, 51, 20) ( 3, 30, 59, 52, 21) ( 41, 48, 39, 17, 25) ( 40, 47, 38, 16, 29) ( 49, 35, 18, 26, 42) ( 43, 45, 36, 19, 27) ( 44, 46, 37, 15, 28) ( 13, 12, 11, 10, 14),
Permutation( 28, 45) ( 43, 12) ( 13, 44) ( 27, 49) ( 14, 40) ( 15, 2) ( 10, 41) ( 19, 1) ( 37, 21) ( 11, 42) ( 46, 29) ( 36, 20) ( 47, 25) ( 35, 24) ( 34, 52) ( 48, 26) ( 33, 51) ( 3, 16) ( 31, 54) ( 6, 55) ( 56, 7) ( 30, 53) ( 57, 8) ( 39, 23) ( 58, 9) ( 38, 22) ( 18, 0) ( 59, 5) ( 50, 32) ( 17, 4)])
...
DicHexeCon_PDB = {1:0,2:1,3:2,4:3,5:4,6:9,7:22,8:21,9:41,10:40,11:49,12:48,13:33,14:32,15:5,16:8,17:23,18:24,19:20,20:42,21:43,22:44,23:45,
24:46,25:47,26:34,27:30,28:31,29:6,30:7,31:53,32:52,33:25,34:29,35:28,36:13,37:12,38:11,39:36,40:35,41:39,42:57,43:56,44:55,45:54,46:51,47:26,48:27,
49:14,50:10,51:37,52:38,53:58,54:59,55:50,56:16,57:15,58:19,59:18,60:17}

PermGroup = open('PermutGroup.txt','r')
PermGroupAlt = open('PGroupAlt.txt','w')
n = []
m = -1
for i in PermGroup.readlines():
    i = ((i.strip()).split(')('))
    for ele in i:
        if ele.startswith('Permutation('):
            ele = (ele.split('('))
            m+=1
            print m , '\t',m , m
            for i in n:
            ...
            ele = ele[1]
            ele = map(int ,ele.split(' '))
            print >> PermGroupAlt, "\n\bPermutation(",
            for L in ele[:-1]:
                n.append(L)
                print >> PermGroupAlt, str(DicHexeCon_PDB[L])+',',
            print >> PermGroupAlt, str(DicHexeCon_PDB[ele[-1]])+')',
            n.append(ele[-1])
        elif ele.startswith('PermutationGrou'):
            continue
        else:
            ele = ele.split(')')
            ele = ele[0]
...
for pepe in dodecahedron.pgroup:
    m = np.eye(20)
    m = np.array(pepe(m))
    Matrizes.append(m)
change = 10
MatrizesNovas = []
MatrizesVelhas = Matrizes
while change !=0:
    for M1 in MatrizesVelhas:
        for M2 in MatrizesVelhas:
            Mprod = np.dot(M1,M2)
            value = 1
            for i in MatrizesVelhas:
                if np.array_equal(Mprod,i):
                    value = 0
            if value == 1:
                MatrizesNovas.append(Mprod)
    change = len(MatrizesNovas)-len(MatrizesVelhas)
    MatrizesVelhas = MatrizesNovas
    print len(MatrizesVelhas)
...
for i in range(10):
    for i in itertools.combinations(L,i+1):
        lista = np.zeros((20))
        for n in i:
            lista[n]=1
        p=[]
        vect = np.array(lista)
        for pepe in MatrizesVelhas:
            p.append(tuple(np.dot(vect,pepe)))
        d={}
        for el in p:
            d[el]=None
        p = d.keys()
        if len(Permut)==0:
            ...
            for element in p:
                for v in Permut:
                    if np.array_equal(np.array(v),element):
                        value = 0
            if value== 1:
                Permut[tuple(vect)]=p
    for e in Permut.keys():
        d={}
        for arr in Permut[e]:
            d[tuple(arr)]=None
        Permut[e]= d.keys()

    Combinacoes.append(Permut)
    Permut = {}
